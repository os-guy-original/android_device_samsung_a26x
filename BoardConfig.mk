...
BOARD_KERNEL_CMDLINE := bootconfig loop.max_part=7 buildtime_bootconfig=enable
...
BOARD_AVB_PRISM_KEY_PATH := external/avb/test/data/testkey_rsa4096.pem
BOARD_AVB_PRISM_ALGORITHM := SHA256_RSA4096
BOARD_AVB_PRISM_ROLLBACK_INDEX := 2
BOARD_AVB_PRISM_ROLLBACK_INDEX_LOCATION := 2

BOARD_AVB_OPTICS_KEY_PATH := external/avb/test/data/testkey_rsa4096.pem
BOARD_AVB_OPTICS_ALGORITHM := SHA256_RSA4096
BOARD_AVB_OPTICS_ROLLBACK_INDEX := 3
BOARD_AVB_OPTICS_ROLLBACK_INDEX_LOCATION := 3

BOARD_AVB_VBMETA_SYSTEM := system product system_dlkm
...
BOARD_AVB_INIT_BOOT_ROLLBACK_INDEX_LOCATION := 1
